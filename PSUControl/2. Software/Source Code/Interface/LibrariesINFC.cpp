...
BYTE slaveSPIAddressINFC = UPPER_SLAVE_SPI_ADDRESS;	// Set to UPPER_SLAVE_SPI_ADDRESS or LOWER_SLAVE_SPI_ADDRESS
...
void LibrariesINFC ( void ){
	...
	iprintf(" (6) A2D measures - MUX & AGC functions all together\n");
