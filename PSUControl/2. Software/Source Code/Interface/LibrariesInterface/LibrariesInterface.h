...
void recI2CMessage_I2CnSPI_INFC( void );	// (3)
...
//*********Private Methods********//
void setMuxesPins_MUX_INFC 		( void );	// (0)
...
void readA2D_MUX_INFC 			( void );	// (5)
void getMuxesStatus_MUX_INFC 	( void );	// (6)

//------------------------------------- RDAC Library ------------------------------------------//
//*********Public Methods*********//
void RDACLibraryINFC			( void );	// RDAC MENU
//*********Private Methods********//
void setRDACValueReg_RDAC_INFC 	( void );	// (0)
void setRDACValueVolts_RDAC_INFC( void );	// (1)
...
void hardwareReset_RDAC_INFC 	( void );	// (C)
