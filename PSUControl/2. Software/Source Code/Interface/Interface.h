...
void setI2CwaitPeriod ( void );						// (6)
void toggleMonitorCTRLPrintFLAG ( void );			// (7)
...
// Status
void valuesDisplayINFC ( void );					// (1)
void statusDisplayINFC ( void );					// (2)
void refreshAlarmStatusINFC ( void );
void refreshValuesStatusINFC ( void );
// Configuration
void configDisplayINFC ( BOOL psu_sni );			// (3&4)
...
void A2DmeasuresINFC ( void );						// (6) - A2d Measuring - puts together MUX & AGC functions
