...
int voltPositiveToCounts 	(float volt, float Rpsu);
float countsToVoltPositive 	(int counts, float Rpsu);
int voltNegativeToCounts 	(float volt, float Rpsu);
float countsToVoltNegative 	(int counts, float Rpsu);
